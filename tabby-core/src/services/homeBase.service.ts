...
export class HomeBaseService {
    ...
    openGitHub (): void {
        this.platform.openExternal('https://github.com/zeroleo12345/tabby')
    }
    ...
    reportBug (): void {
        ...
        this.platform.openExternal(`https://github.com/zeroleo12345/tabby/issues/new?body=${encodeURIComponent(body)}`)
    }
